...
return [
    ...
    'placeholder_by_html_type' => [
        'text' => 'Ingrese [% field_name %]...',
        'number' => 'Ingrese [% field_name %]...',
        'password' => 'Ingrese [% field_name %]...',
        'email' => 'Ingrese [% field_name %]...',
        'select' => 'Seleccione [% field_name %]',
        'multipleSelect' => 'Seleccione [% field_name %]',
    ],
    /*
      |--------------------------------------------------------------------------
    ...
    'generic_view_labels' => [
        'create' => [
            'text' => 'Crear un nuevo [% model_name_title %]',
        ...
        'model_was_added' => [
            'text' => '[% model_name_title %] ha sido añadido con éxito!',
            'template' => 'model_was_added',
        ],
        'model_was_updated' => [
            'text' => '[% model_name_title %] ha sido actualizado con éxito!',
            'template' => 'model_was_updated',
        ],
        'model_was_deleted' => [
            'text' => '[% model_name_title %] ha sido borrado con éxito!',
