    ...
    Plugin.prototype = {
        ...
        _renderSelect: function (data, selected_value) {
            ...
            if (typeof selected_value == "undefined")
                selected_value = this.options.first_optval;
        ...
        _bindSelect: function (id, value) {
            ...
            if (this.options.input_param == null)
                xurl += (id == null) ? "" : id;
            else
                this._addParameter(this.options.input_param, value);
        ...
        init: function () {
            ...
            if (this.options.parent != null) {
                ...
                this._bindSelect(null, self.options.selected_value);
        }
    };
