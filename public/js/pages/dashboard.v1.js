            ...
            },
            {
                ...
                "render": function (url, type, full) {
                    if (full[11] != null) {
                        ...
                        tipo1 = doc[1];
                        if (doc[1] == 'pdf') {
                            return '<a href="img/perfil/' + full[11] + '" target="_blanck"><img src="http://m.blog.hu/tc/tclang/image/pdf.png" class="img-responsive" style="width: 80px;"></a>';
                        } else if (doc[1] == 'pptx' || doc[1] == 'ppt') {
                            return '<a href="img/perfil/' + full[11] + '" target="_blanck"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/37/Antu_application-wps-office.pptx.svg/2000px-Antu_application-wps-office.pptx.svg.png" class="img-responsive" style="width: 80px;"></a>';
                        } else {
